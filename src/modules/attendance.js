...
<<<<<<< HEAD
    ...
    // kalau di dalam tombolnya kepotong). Dibuat sekali, dipakai ulang.
    let ulangBtn = document.getElementById('fotoUlangBtn');
    if (!ulangBtn) {
      ulangBtn = document.createElement('button');
      ulangBtn.type = 'button';
      ulangBtn.id = 'fotoUlangBtn';
      ulangBtn.className = 'secondary-btn';
      ulangBtn.style.cssText = 'width:100%;max-width:190px;display:block;margin:0 auto 4px;';
      ulangBtn.innerHTML = '<i data-lucide="rotate-ccw"></i> Foto Ulang';
      ulangBtn.addEventListener('click', startCamera);
